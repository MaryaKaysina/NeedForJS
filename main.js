...
const scoreResult = parseInt(localStorage.getItem('nfjs_score', setting.score));

topScore.textContent = scoreResult ? "RECORD: " + scoreResult : 0;
...
function startGame(event){
    ...
    for(let i = 0; i < getQuantityElements(HEIGHT_ELEM * setting.traffic); i++) {
        ...
        enemy.y = periodEnemy < 110 ? -110 * setting.traffic * (i + 1) : periodEnemy;
